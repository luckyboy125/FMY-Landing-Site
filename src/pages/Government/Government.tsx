          ...
          <div className="chartHeader">
            <div className="databasePart">
              ...
              <div className="chartTools">
                <ActionButton name="Show" content="This Week" className="chartPeriod" />
                <ActionButton content="Compare" type="common" className="chartCompare" />
              </div>
            </div>
            ...
            <div className="databasePart">
              <div className="descriptionRoot">
                ...
                <div className="descriptionItem" style={{ paddingTop: "26px", paddingBottom: "30px" }}>
                  <div className="descriptionItemTitle">New items (past 7 days)</div>
        ...
        <div className="governmentContentRoot">
          ...
          <div className="governmentContent">
            <div className="governmentContentItemRoot">
              <GovernmentCard imgRoot={<img src={neymar1} alt="neymar" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={neymar3} alt="neymar" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={messi3} alt="messi" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={mbappe} alt="mbappe" />} className="governmentContentItem" />
            </div>
            <div className="governmentContentItemRoot">
              <GovernmentCard imgRoot={<img src={neymar2} alt="neymar" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={messi2} alt="messi" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={messi4} alt="messi" />} className="governmentContentItem" />
            </div>
            <div className="governmentContentItemRoot">
              <GovernmentCard imgRoot={<img src={messi1} alt="messi" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={ronaldo1} alt="ronaldo" />} className="governmentContentItem" />
              <GovernmentCard imgRoot={<img src={ronaldo2} alt="ronaldo" />} className="governmentContentItem" />
            </div>
          </div>
        </div>
      </div>

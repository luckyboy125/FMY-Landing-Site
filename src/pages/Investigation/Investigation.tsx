            ...
            <ActionTab
              ...
              select={
                query.get("investigation_tab") === null
                  ? tabData[0]
                  : (query.get("investigation_tab") ?? tabData[0])
              }
            />
          </div>
        </div>
          ...
          <div className="investigationContent3">
            <div className="postAnalysisRoot">
              ...
              <div className="postContentRoot">
                ...
                <div className="postContent">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit in diam proin
                  tincidunt velit accumsan eget. Pulvinar urna, sed nunc pretium consectetur
                  diam. Dignissim cursus vestibulum posuere placerat commodo nunc, mattis
                  aliquam cursus. Posuere placerat sed dolor eget integer. Nunc, condimentum
                  interdum nisl turpis praesent integer at. Ullamcorper scelerisque quisque
                  quam nibh laoreet a, tempus venenatis. Viverra tellus urna ridiculus mauris
                  et porta odio dui. Sit condimentum aliquam ut nunc, fringilla tempus sodales
                  pulvinar habitant. Adipiscing ut adipiscing in scelerisque. Vel lorem nec
                  scelerisque augue tincidunt. Rhoncus maecenas sollicitudin lacinia ac
                  adipiscing. Morbi nec purus faucibus odio hac sit ut ultrices dictum. Vitae
                  maecenas convallis nisl et, iaculis vulputate felis vitae. Nibh odio
                  imperdiet magna vitae consequat iaculis tempus massa. Et nunc nulla sit
                  elementum, laoreet justo. Senectus arcu est rutrum sagittis, vel. Lorem
                  tristique in vulputate morbi gravida nec. Tristique laoreet neque nibh
                  varius faucibus. Pellentesque eu sit in dui gravida pellentesque. Risus,
                  donec quis magna curabitur morbi convallis tincidunt. Libero, pellentesque
                  tempor, consequat cum pellentesque diam a, morbi in. Enim adipiscing
                  laoreet consectetur consequat. Bibendum aliquet ut magna habitant felis sit
                  nunc. Ac nunc mauris massa pellentesque lectus suspendisse. Read more
                </div>
            ...
            <div className="hashtagAnalysisRoot">
              ...
              <div className="hashtagAnalysisRoot1">
                <HashtagChartCard
                  chartData={[
                    { color: "#A0D7E7", value: 60 },
                    { color: "#A0D7E7", value: 90 },
                    { color: "#A0D7E7", value: 30 },
                    { color: "#75B3FF", value: 45 },
                  ]}
                  title="Hashtage Used"
                  size="4.5M"
                  description="+58.2 %"
                ...
                <HashtagChartCard
                  chartData={[
                    { color: "#CFC8FF", value: 77 },
                    { color: "#CFC8FF", value: 100 },
                    { color: "#6C5DD3", value: 100 },
                    { color: "#CFC8FF", value: 20 },
                  ]}
                  title="Total Posts"
                  size="2.1M"
                  description="+102.2 %"
                ...
                <div className="contentRoot">
                  {wordCloudAnalysisData?.map((item, index) => (
                    <div
                      ...
                      style={{
                        background:
                          index % 2 === 0 ? "transparent" : "rgba(249, 249, 250, 0.1)",
                      }}
                    >
